...
fabric-ca-client register --caname ${org_ca_name} --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/${org_name}/tls-cert.pem"
...
fabric-ca-client enroll -u https://orderer:ordererpw@${org_ca_address}:${org_ca_port} --caname ${org_ca_name} -M "${PWD}/organizations/ordererOrganizations/${DOMAIN}/orderers/${org_name_with_domain}/msp" --csr.hosts ${org_name_with_domain} --csr.hosts ${org_ca_address} --tls.certfiles "${PWD}/organizations/fabric-ca/${org_name}/tls-cert.pem"
...
fabric-ca-client enroll -u https://${org_name}admin:${org_name}adminpw@${org_ca_address}:${org_ca_port} --caname ${org_ca_name} -M "${PWD}/organizations/ordererOrganizations/${DOMAIN}/users/Admin@${DOMAIN}/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/${org_name}/tls-cert.pem"
